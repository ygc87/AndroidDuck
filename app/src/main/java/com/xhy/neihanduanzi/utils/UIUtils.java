...
//    static boolean isFitsSystemWindows(final Activity activity_lock_screen) {
//        return ((ViewGroup) activity_lock_screen.findViewById(android.R.id.content)).getChildAt(0).
