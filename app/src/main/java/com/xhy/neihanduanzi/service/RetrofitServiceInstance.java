package com.xhy.neihanduanzi.service;
...
//                Rest tokenRequest = null;
//                XHYApplication application = new XHYApplication();
//                    if (TextUtils.isEmpty(XHYApplication.getToken())) {
//                    //L.d("MyApplication 的token值为空！！！！！！！！！！！！！");
//                    return chain.proceed(originalRequest);
//                }
//                    tokenRequest = originalRequest.newBuilder()
//                        .header("token",XHYApplication.getToken())
//                        .build();
//
