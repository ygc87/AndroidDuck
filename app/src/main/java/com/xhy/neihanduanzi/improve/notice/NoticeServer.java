package com.xhy.neihanduanzi.improve.notice;
...
import com.xhy.neihanduanzi.improve.bean.base.ResultBean;
...
//        context.startService(intent);
    ...
    public void onCreate() {
        ...
        if (application instanceof XHYApplication) {
    ...
    private synchronized void refreshNoticeForNet() {
        ...
        mRunning = true;
//        XHYApi.getNotice(new TextHttpResponseHandler() {
//            @Override
...
//        });
    ...
    private synchronized void clearNoticeForNet(int flag) {
        ...
        if ((flag & NoticeManager.FLAG_CLEAR_MENTION) == NoticeManager.FLAG_CLEAR_MENTION
            ...
            mRunning = true;
//            XHYApi.clearNotice(flag, new TextHttpResponseHandler() {
//                @Override
//                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
//                    log("onFailure:" + statusCode + " " + responseString);
//                    doNetFinish(null);
