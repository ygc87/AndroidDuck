...
abstract class BaseView extends FrameLayout {
    ...
    /*** The Ic back image.***/
    @DrawableRes
    private int icBackImage = chuangyuan.ycj.videolibrary.R.drawable.ic_exo_back;
    ...
    public BaseView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int loadId = chuangyuan.ycj.videolibrary.R.layout.simple_exo_play_load;
        int preViewLayoutId = 0;
        int barrageLayoutId = 0;
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView, 0, 0);
            try {
                icBackImage = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_back_image, icBackImage);
                userWatermark = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_user_watermark, 0);
                isListPlayer = a.getBoolean(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_list, false);
                defaultArtworkId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_default_artwork, defaultArtworkId);
                loadId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_load_layout_id, loadId);
                preViewLayoutId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_preview_layout_id, preViewLayoutId);
                barrageLayoutId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_barrage_layout_id, barrageLayoutId);
                int playerViewId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_controller_layout_id, chuangyuan.ycj.videolibrary.R.layout.simple_exo_playback_control_view);
                if (preViewLayoutId == 0 && (playerViewId == chuangyuan.ycj.videolibrary.R.layout.simple_exo_playback_list_view || playerViewId == chuangyuan.ycj.videolibrary.R.layout.simple_exo_playback_top_view)) {
                    preViewLayoutId = chuangyuan.ycj.videolibrary.R.layout.exo_default_preview_layout;
                }
            } finally {
                a.recycle();
            }
    ...
    private void intiView() {
        ...
        exoControlsBack.setId(chuangyuan.ycj.videolibrary.R.id.exo_controls_back);
        ...
        exoLoadingLayout.setBackgroundColor(ContextCompat.getColor(getContext(), chuangyuan.ycj.videolibrary.R.color.simple_exo_color_33));
        ...
        LayoutParams layoutParams = new LayoutParams(VideoPlayUtils.dip2px(getContext(), 35f), VideoPlayUtils.dip2px(getContext(), 35f));
        frameLayout.addView(exoControlsBack, frameLayout.getChildCount(), layoutParams);
        int index = frameLayout.indexOfChild(findViewById(chuangyuan.ycj.videolibrary.R.id.exo_controller_barrage));
        ...
        exoPlayWatermark = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_watermark);
        videoLoadingShowText = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_loading_show_text);

        exoPreviewBottomImage = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_image_bottom);
        if (playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_image) != null) {
            exoPreviewImage = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_image);
        ...
        exoPreviewPlayBtn = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_play);
    }
    ...
    protected void showDialog() {
        ...
        alertDialog.setTitle(activity.getString(chuangyuan.ycj.videolibrary.R.string.exo_play_reminder));
        alertDialog.setMessage(activity.getString(chuangyuan.ycj.videolibrary.R.string.exo_play_wifi_hint_no));
    ...
    protected void showPreViewLayout(int visibility) {
        if (exoPlayPreviewLayout != null) {
            ...
            if (playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_play) != null) {
                playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_preview_play).setVisibility(visibility);
            }
        }
    }
