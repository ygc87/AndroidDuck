...
class LockControlView extends FrameLayout implements View.OnClickListener, AnimUtils.AnimatorListener {
    ...
    public LockControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, @NonNull final BaseView baseView) {
        ...
        exoPlayLockLayout = inflate(context, chuangyuan.ycj.videolibrary.R.layout.simple_exo_play_lock, null);
        exoPlayLockLayout.setBackgroundColor(Color.TRANSPARENT);
        exoPlayerLockProgress = exoPlayLockLayout.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_lock_progress);
        lockCheckBox = exoPlayLockLayout.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_lock_btn_id);
        exoControllerRight = baseView.getPlaybackControlView().findViewById(chuangyuan.ycj.videolibrary.R.id.exo_controller_right);
        exoControllerLeft = baseView.getPlaybackControlView().findViewById(chuangyuan.ycj.videolibrary.R.id.exo_controller_left);
