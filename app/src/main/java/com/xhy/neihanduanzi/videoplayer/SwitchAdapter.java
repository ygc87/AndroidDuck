...
public class SwitchAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            textView = (AppCompatTextView) mInflater.inflate(chuangyuan.ycj.videolibrary.R.layout.simple_exo_belowview_item, parent, false);
        } else {
            textView = (AppCompatTextView) convertView;
        }
        textView.setText(data.get(position));
        if (position == selectIndex) {
            textView.setTextColor(ContextCompat.getColor(mContext, chuangyuan.ycj.videolibrary.R.color.simple_exo_color_switch_item));
        } else {
