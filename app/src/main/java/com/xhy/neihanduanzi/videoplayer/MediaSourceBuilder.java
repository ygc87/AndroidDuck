...
public class MediaSourceBuilder {
    private static final String TAG = chuangyuan.ycj.videolibrary.video.MediaSourceBuilder.class.getName();
    /*** The Context.*/
    ...
    public MediaSource initMediaSource(Uri uri) {
        ...
        switch (streamType) {
            ...
            case C.TYPE_HLS:
                Log.d(TAG, "TYPE_HLS");
                return new HlsMediaSource(uri, getDataSource(), mainHandler, null);
            default:
                throw new IllegalStateException(context.getString(chuangyuan.ycj.videolibrary.R.string.media_error));
        }
    }
