...
public final class VideoPlayerView extends BaseView {
    ...
    private void intiClickView() {
        if (playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_replay_btn_id) != null) {
            playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_replay_btn_id).setOnClickListener(onClickListener);
        }
        if (playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_error_btn_id) != null) {
            playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_error_btn_id).setOnClickListener(onClickListener);
        }
        if (playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_btn_hint_btn_id) != null) {
            playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_player_btn_hint_btn_id).setOnClickListener(onClickListener);
        }
        getSwitchText().setOnClickListener(onClickListener);
        exoControlsBack.setOnClickListener(onClickListener);
        playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.exo_video_fullscreen).setOnClickListener(onClickListener);
    ...
    public void showFullscreenTempView(int visibility) {
        AppCompatCheckBox compatCheckBox = playerView.findViewById(chuangyuan.ycj.videolibrary.R.id.sexo_video_fullscreen);
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_video_fullscreen || v.getId() == chuangyuan.ycj.videolibrary.R.id.sexo_video_fullscreen) {
                //切竖屏portrait screen
            ...
            } else if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_controls_back) {
                activity.onBackPressed();
            } else if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_player_error_btn_id) {
                if (VideoPlayUtils.isNetworkAvailable(activity)) {
                    showErrorState(View.GONE);
                    mExoPlayerListener.onCreatePlayers();
                } else {
                    Toast.makeText(activity, chuangyuan.ycj.videolibrary.R.string.net_network_no_hint, Toast.LENGTH_SHORT).show();
                }
            } else if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_player_replay_btn_id) {
                if (VideoPlayUtils.isNetworkAvailable(activity)) {
                ...
                //切换
            } else if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_video_switch) {
                if (belowView == null) {
                ...
                //提示播放
            } else if (v.getId() == chuangyuan.ycj.videolibrary.R.id.exo_player_btn_hint_btn_id) {
    ...
    private ExoPlayerViewListener exoPlayerViewListener = new ExoPlayerViewListener() {
        ...
        public void setSwitchName(@NonNull List<String> name, int switchIndex) {
            this.setSwitchName(name, switchIndex);
        }
    };
