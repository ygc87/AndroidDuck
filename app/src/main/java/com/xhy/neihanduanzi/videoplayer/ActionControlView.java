...
class ActionControlView extends FrameLayout {
    ...
    public ActionControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, @NonNull PlayerView playerView) {
        ...
        int replayId = chuangyuan.ycj.videolibrary.R.layout.simple_exo_play_replay;
        int errorId = chuangyuan.ycj.videolibrary.R.layout.simple_exo_play_error;
        int playerHintId = chuangyuan.ycj.videolibrary.R.layout.simple_exo_play_btn_hint;
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView, 0, 0);
            try {
                replayId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_replay_layout_id, replayId);
                errorId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_error_layout_id, errorId);
                playerHintId = a.getResourceId(chuangyuan.ycj.videolibrary.R.styleable.VideoPlayerView_player_hint_layout_id, playerHintId);
            } finally {
                a.recycle();
            }
        }
