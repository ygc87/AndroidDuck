...
import com.xhy.neihanduanzi.utils.UIUtils;
...
public class TipView extends LinearLayout {
    ...
    private int mBackGroundErrColor;
    ...
    public TipView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackGroundColor = ta.getColor(R.styleable.TipView_tipBackgroundColor, Color.parseColor("#D5E8F6"));
        mBackGroundErrColor = ta.getColor(R.styleable.TipView_tipBackgroundColor, Color.parseColor("#FA505A"));
        mTextColor = ta.getColor(R.styleable.TipView_tipTextColor, Color.parseColor("#4592C6"));
    ...
    public void showError(String content) {
        ...
        setBackgroundColor(mBackGroundErrColor);
