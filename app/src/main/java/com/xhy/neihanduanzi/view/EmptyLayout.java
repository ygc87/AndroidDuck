...
public class EmptyLayout extends LinearLayout implements
    ...
    public static final int EMPTY_CONTENT = 7;
    public static final int EMPTY_COMMENT_CONTENT = 8;
    ...
    public void init() {
        ...
        tvEmptyContent = (TextView) view.findViewById(R.id.tv_empty_content);
...
//                }
            ...
            case NODATA:
                ...
                //img.setBackgroundResource(R.mipmap.ic_tip_fail);
                //Glide.with(mContext).load(R.drawable.cry1).asGif().into(img);
                //Glide.with(mContext).load(R.drawable.net_err).asGif().diskCacheStrategy(DiskCacheStrategy.SOURCE).into(img);
                img.setVisibility(View.VISIBLE);
                //mLoading.stop();
                //mLoading.setVisibility(View.GONE);
                setTvNoDataContent();
            ...
            case NO_LOGIN:
                ...
                ImageLoader.loadGif(mContext, R.drawable.net_err, img);
                img.setVisibility(View.VISIBLE);
                //mLoading.stop();
                //mLoading.setVisibility(View.GONE);
            ...
            case EMPTY_CONTENT:
                ...
                setTvNoDataContent();
                break;
            case EMPTY_COMMENT_CONTENT:
                tvEmptyContent.setVisibility(View.VISIBLE);
                tvEmptyContent.setText("期待您的评论");
